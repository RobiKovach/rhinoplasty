(() => {
    ...
    function countdown(endDate) {
        ...
        setInterval(calculate, 1e3);
        function calculate() {
            let startDate = (new Date).getTime();
            let timeRemaining = parseInt((endDate - startDate) / 1e3);
            if (timeRemaining >= 0) {
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        [].forEach.call(document.querySelectorAll(".tel"), (function(input) {
            ...
            function mask(event) {
                ...
                var matrix = "41 (___) ___ ____", i = 0, def = matrix.replace(/\D/g, ""), val = this.value.replace(/\D/g, ""), new_value = matrix.replace(/[_\d]/g, (function(a) {
